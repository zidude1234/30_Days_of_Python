...
#5. Print the following pattern:
  ...
  #2 
  fruits, reverse_fruits = ['banana', 'orange', 'mango', 'lemon'],[]
  print("Number 2")
  for i in range(1,len(fruits)+1):
    reverse_fruits.append(fruits[-i])
  print(f"{reverse_fruits}")
  print('\n')
...
countries_data = [
  ...
  _population = 0
  print("Number 3")
  length_of_list = len(countries_data)
  for i in range(length_of_list):
    temp_data = countries_data[i]
    _country = temp_data["name"]
    _language = temp_data["languages"]
    _population = temp_data["population"]
    dict_lang = list((_country,_language,_population))
    reduced_list.append(dict_lang)
  ...
  print("Countries which speak Arabic",temp_language_list.count('Arabic'))
